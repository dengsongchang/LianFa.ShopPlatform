...
namespace LianFa.ShopPlatform.Code.Helper
{
    ...
    public static class CommonHelper
    {
        ...
        /// 获取文件完整地址
        /// </summary>
        public static string GetFileFullUrl(string url)
        {
            return HttpContext.Current.Request.Url.Scheme + "://" + HttpContext.Current.Request.Url.Authority + url;
        }
        ...
        /// <returns></returns>
        public static List<T> GetFileFullUrl<T>(this List<T> source, Func<T, string> keySelector)
        {
            Func<T, string> s = x => GetFileFullUrl(keySelector.Invoke(x));

            Action<T> action = x => s.Invoke(x);
        ...
        //public T GetObject<T>(this T source, Func<T, string> keySelector)
        //{
        //    var s = GetFileFullUrl(keySelector.Invoke(source);
        //    return T;
        //}
