...
using LianFa.ShopPlatform.WebApi;
...
namespace LianFa.ShopPlatform.WebApi
{
        ...
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration
                .EnableSwagger(c =>
                {
                    ...
                    //
                    c.SingleApiVersion("v1", "LianFa.ShopPlatformApi");
                    ...
                    //设置接口描述xml路径地址
                    c.IncludeXmlComments(string.Format("{0}/bin/HuCheng.Util.Core.xml", AppDomain.CurrentDomain.BaseDirectory));
                    c.IncludeXmlComments(string.Format("{0}/bin/LianFa.ShopPlatform.WebApi.XML", System.AppDomain.CurrentDomain.BaseDirectory));
                    c.IncludeXmlComments(string.Format("{0}/bin/LianFa.ShopPlatform.Model.XML", System.AppDomain.CurrentDomain.BaseDirectory));
                ...
                .EnableSwaggerUi(c =>
                {
                    ...
                    c.InjectJavaScript(thisAssembly, "LianFa.ShopPlatform.WebApi.Scripts.swaggerui.swagger_lang.js");
    ...
    public class CachingSwaggerProvider : ISwaggerProvider
    {
        ...
        /// 获取Swagger描述
        /// </summary>
        /// <param name="rootUrl">根目录路径</param>
        ...
        {
            string xmlpath = String.Format("{0}/bin/LianFa.ShopPlatform.WebApi.XML", AppDomain.CurrentDomain.BaseDirectory);
