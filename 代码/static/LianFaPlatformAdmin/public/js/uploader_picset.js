function uploadFoodPic(imgId, picId,url) {
    ...
    uploader.on('uploadSuccess', function(file, response) {
        ...
        // $('#uploader_food_btn').hide()
        // $('#uploader_food_btn').css('position','absolute').css('background',"url()")
        $(imgId).attr('data-src',response.Data);
        swal.close()
