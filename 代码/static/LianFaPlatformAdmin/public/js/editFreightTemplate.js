...
`,
    ...
    adminTemplatesInfo: function() {
        ...
        SignRequest.set(methodName, data, function(data) {
            console.log(data)
            if (data.Code == "100") {
                if (data.Data.AdminTemplatesInfo.ShippingTemplates.ValuationMethod == "4") {
                ...
                if (data.Data.AdminTemplatesInfo.ShippingTemplates.ValuationMethod == "5") {
