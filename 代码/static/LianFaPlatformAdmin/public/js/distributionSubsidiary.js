...
var distributionSubsidiary = {
    init: function () {
        ...
        $('body').on('click', '#search', function () {
            distributionSubsidiary.projectQuery();
        })
        //导出按钮点击
    ...
    exportAdminDistributionDetailList:function(){
        var methodName = "/Distribution/ExportAdminDistributionDetailList";
        var data = {
    ...
    initBootstrapTable: function () {
        $('#productTable').bootstrapTable({
            method: 'post',
            url: SignRequest.urlPrefix + '/Distribution/AdminDistributionDetailList',
            dataType: "json",
    ...
    queryParams: function (params) {
        //配置参数
        //方法名
        var methodName = "/Distribution/AdminDistributionDetailList";
    ...
    responseHandler: function (res) {
        if (res.Data != null) {
            console.log(res);
            return {
                "rows": res.Data.AdminDistributionDetailList,
