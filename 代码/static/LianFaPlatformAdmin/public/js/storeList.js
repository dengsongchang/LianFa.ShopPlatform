var StoreList = {
    ...
    initBootstrapTable: function () {
        $('#brand_box').bootstrapTable({
            method: 'post',
            url: SignRequest.urlPrefix + '/stores/AdminStoreList',
            dataType: "json",
            ...
            columns: [
                ...
                //         var html = '<input type="checkbox" class="checkbox order_checkbox" data-id="'+ row.SId +'">'
                //         return html;
                //     }
                // },
                // {
                ...
                },
                {
                    ...
                    formatter: function (value, row, index) {
                        if(row.Status == "0"){
                            var html = '<a class="editor" href="/store/storeEdit?id=' + row.SId + '">编辑</a>';
                        }else{
                            var html =
                                ...
                                '<a class="editor" href="/store/storeEdit?id=' + row.SId + '">查看</a>';
                        }
                        return html;
                    }
                },
