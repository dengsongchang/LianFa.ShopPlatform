...
var withdrawalList = {
    ...
    adminAuditSplitCommWithdraw:function(){
        var methodName = "/SplitCommWithdraw/AdminAuditSplitCommWithdraw";
        var data = {
            "SpWdrId": withdrawalList.SpWdrId,
            "Remark": $('.remark').val(),
            "Status": $('input[name="saleState"]:checked').val(),
        };
        //请求接口
    ...
    initBootstrapTable: function () {
        $('#productTable').bootstrapTable({
            method: 'post',
            url: SignRequest.urlPrefix + '/SplitCommWithdraw/AdminSplitCommWithdrawList',
            dataType: "json",
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function (value, row, index) {
                        var html =
                            '<span style="padding: 0 6px;color:#44b8fd;cursor: pointer"  class="examain" data-id="' + row.SpWdrId + '">审核</span>'
    ...
    queryParams: function (params) {
        //配置参数
        //方法名
        var methodName = "/SplitCommWithdraw/AdminSplitCommWithdrawList";
