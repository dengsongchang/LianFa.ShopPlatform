...
var PopAdd = {
    ...
    preHandle: function() {
        if (PopAdd.viewer) {
            PopAdd.viewer.destroy();
        }
        PopAdd.viewer = new Viewer(document.getElementById('dowebok'), {
            url: 'data-original',
            show: function() {
                PopAdd.viewer.update();
            },
        });
    ...
    adminAddPopUpAdverts: function() {
        ...
        //请求方法
        var methodName = "/adverts/AdminAddPopUpAdverts";
        data.Id = 0
    ...
    initProBootstrapTable: function() {
        $('#choice_goods_tb').bootstrapTable({
            ...
            queryParams: PopAdd.queryProParams, //参数
            queryParamsType: "limit", //参数格式,发送标准的RESTFul类型的参数请求
            toolbar: "#toolbar", //设置工具栏的Id或者class
            responseHandler: PopAdd.responseProHandler,
            columns: [{
                    field: 'ShowImg',
                    title: '图片',
                    align: 'center',
    ...
    initPerformanceBootstrapTable: function() {
        $('#choice_performance_tb').bootstrapTable({
            ...
            clickToSelect: true, //点击行即可选中单选/复选框
            sidePagination: "server", //表格分页的位置
            queryParams: PopAdd.queryPerformanceParams, //参数
            queryParamsType: "limit", //参数格式,发送标准的RESTFul类型的参数请求
            toolbar: "#toolbar", //设置工具栏的Id或者class
            responseHandler: PopAdd.responsePerformanceHandler,
            columns: [
    ...
    initBootstrapTable: function() {
        $('#tb_limit_content').bootstrapTable({
            ...
            clickToSelect: true, //点击行即可选中单选/复选框
            sidePagination: "server", //表格分页的位置
            queryParams: PopAdd.queryParams, //参数
            queryParamsType: "limit", //参数格式,发送标准的RESTFul类型的参数请求
            toolbar: "#toolbar", //设置工具栏的Id或者class
            responseHandler: PopAdd.responseHandler,
            columns: [
