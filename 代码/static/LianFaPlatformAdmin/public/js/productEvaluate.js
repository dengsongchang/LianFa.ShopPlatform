...
var ProductEvaluate = {
    ...
    adminDelEvaluate:function (id) {
        //请求方法
        var methodName = "/productreview/AdminDelProductReviews";
        var data = {
            "ReviewId": id
        };
        //请求接口
    ...
    initBootstrapTable:function(){
        $('#evaluateTable').bootstrapTable({
            method: 'post',
            url: SignRequest.urlPrefix + '/productreview/AdminProductReviewsList',
            dataType: "json",
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function(value, row, index) {
                        var html = "";
                        html += "<span class='status_reply' data-id='" + value + "'>回复</span>";
    ...
    queryParams: function(params) {
        //配置参数
        //方法名
        var methodName = "/productreview/AdminProductReviewsList";
