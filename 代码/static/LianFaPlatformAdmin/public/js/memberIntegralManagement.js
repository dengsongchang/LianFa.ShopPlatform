...
var MemberIntegralManagement = {
    ...
    init:function(){
        $('body').on('click','.status_delete',function(){
            ...
            Common.confirmDialog('确认要删除?',function(){
                MemberIntegralManagement.adminDelCreditSetting(id)
            })
        })


        MemberIntegralManagement.initBootstrapTable();
    },
    ...
    // 删除记录
    adminDelCreditSetting:function (Id) {
        var methodName = "/credit/AdminDelCreditSetting";
        var data = {
            RecordId: Id
        };
        SignRequest.set(methodName, data, function (data) {
            if (data.Code == "100") {
                MemberIntegralManagement.refreshQuery();
    ...
    //积分管理列表bootstrapTable
    initBootstrapTable:function(){
        $('#memberTable').bootstrapTable({
            method: 'post',
            url: SignRequest.urlPrefix + '/credit/AdminGetCreditSetting',
            dataType: "json",
            ...
            queryParams: MemberIntegralManagement.queryParams, //参数
            queryParamsType: "limit", //参数格式,发送标准的RESTFul类型的参数请求
            toolbar: "#toolbar", //设置工具栏的Id或者class
            responseHandler: MemberIntegralManagement.responseHandler,
            columns: [
                {
                    field: 'RecordId',
                    title: '编号',
    ...
    refreshQuery: function(parame) {
        //方法名
        var methodName = "/credit/AdminGetCreditSetting";
